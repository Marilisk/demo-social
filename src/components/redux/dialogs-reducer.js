...
const dialogsReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case START_DIALOG:
            let newСompanion = { id: action.userId, fullName: action.fullName, messages: [action.messages], };
            return {
                ...state,
                dialogsData: [...state.dialogsData, newСompanion],
            }
        default:
            return state;
    }
...
export const startDialogAC = (userId, messages, fullName) => ({ type: START_DIALOG, userId, messages, fullName });
